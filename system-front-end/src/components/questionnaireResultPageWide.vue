  ...
  <div style="background-color: #EEF6F2; width: 100vw; height: 100vh;">
    ...
    <div class="result-box">
      ...
      <div class="bottom-result-box">
        ...
        <div class="questionnaire-result-box" style="margin-top: 1.5vh">
          <div class="score-box">
    ...
    <div class="description-box">
      ...
      <div class="description-tool-box">
        <div class="description-illustration">
          <img src="../assets/system-result-illustration-wide.png">
        </div>
        <div class="description-button-group">
          <button class="description-button-pri" @click="backToLandingPage">重新参与测试</button>
          <button class="description-button-pri" style="margin-top: 1.5vh">打印详细结果</button>
...
<script>
export default {
  name: "questionnaireResultPageWide",
  data(){
    return{
      depressionScore: 0,
      anxietyScore: 0,
...
<style scoped>
@import "./stylesheets/questionnaire-result-page-wide.css";
</style>